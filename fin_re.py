...
driver = webdriver.Chrome('C:/Users/aq348/Desktop/Python/chromedriver.exe') # 크롬 웹 드라이버 경로 복사 해서 붙여넣기
...
f = open('finance_data.txt', 'r')
lines = f.readlines() # finance.csv 파일의 id가 리스트로 저장 되어있음
 # 에러나서 튕겼을 시 아래 문구 추가
